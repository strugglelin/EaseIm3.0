...
public class ChatActivity extends BaseInitActivity implements EaseTitleBar.OnBackPressListener, EaseTitleBar.OnRightClickListener, ChatFragment.OnFragmentInfoListener {
    ...
    private void initChatFragment() {
        ...
        Log.e("tag","EXTRA_CONVERSATION_ID="+conversationId+ ",EXTRA_CHAT_TYPE="+chatType);
        Log.e("tag","HISTORY_MSG_ID="+historyMsgId+ ",EXTRA_IS_ROAM="+DemoHelper.getInstance().getModel().isMsgRoaming());
